...
<div class="d-flex justify-content-center my-4">
  <img src="/assets/img/DarkSkies_16.JPG" alt="Stargazing event at Spring Mountains Vistitor Gateway" class="img-fluid mb-4">
</div>
...
<div class="row mt-4">
  ...
  <div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="assets/imgDarkSkies_1.jpg" alt="Rachel with a s'mores around the campfire" class="img-fluid rounded z-depth-1" %}
  </div>
  <div class="col-sm mt-3 mt-md-0">
...
<div class="caption">
  The evening included science talks, educational booths, and s'mores around a campfire.
</div>
